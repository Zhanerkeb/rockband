...
class Articles extends Component {
    ...
    handleDelete = id => {
        ...
        axios.delete(`${base_url}/musical-directions/${id}`, { headers: {"Authorization" : `Bearer ${token}`} }).then(res => {
            this.getData();
        }).catch(err => {
            alert(err);
        })
    ...
    handleOk = e => {
        ...
        if (this.state.name.length > 0) {
            ...
            axios.post(`${base_url}/musical-directions`, {
    ...
    handleEditOk = e => {
        ...
        if (this.state.edit_name.length > 0) {
            ...
            axios.put(`${base_url}/musical-directions/${this.state.editid}`, {
    ...
    render() {
        ...
        return (
            <div>
                <Button type="primary" onClick={this.showModal} className={'mb-20'}>Add Musical Direction</Button>
                <Modal
                    visible={visible}
                    title="Create Musical Direction"
                    onOk={this.handleOk}
